...
public class PerlinGenerator : MonoBehaviour
{
    ...
    public float PerlinSteppedPosition(Vector3 worldPosistion)
    {
        int xToSample = Mathf.FloorToInt(worldPosistion.x + perlinGridStepSizeX * .5f);
        int yToSample = Mathf.FloorToInt(worldPosistion.z + perlinGridStepSizeY * .5f);
